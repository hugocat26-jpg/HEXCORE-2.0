(function initSampleData(global) {
  ...
  const hexcores = [
    ...
    { id: 'mystery-box', name: '神秘贤者·盲盒', type: 'violet', desc: '全程1次：从本轮卡池所有选手中抽卡，选中他队选手时转队并给原队长补偿回合。', status: 'available', uses: 1, mode: 'manual' },
    ...
    { id: 'hellhound', name: '地狱三头犬', type: 'violet', desc: '第1轮专用：连续从侏儒马、中等马、上等马三池自选，超时则随机分配。', status: 'available', uses: 1, mode: 'manual' },
  ...
  Hexcore2.sampleData = {
    ...
    players: [
      ...
      { id: 'p112', lane: '上路', name: '林间石', gameId: 'LJ_Stone', score: 57, tier: 1, kda: '1.9', damage: '7.8K', winRate: '38%', heroes: ['石', '树', '熊'], status: 'available' },
      { id: 'p113', lane: '辅助', name: '薄雾铃', gameId: 'BW_Bell', score: 55, tier: 1, kda: '2.1', damage: '5.4K', winRate: '42%', heroes: ['猫', '璐', '风'], status: 'available' },
    ...
    hexcoreAssignments: {
      ...
      c7: take('origin', 'double-shot', 'mystery-box'),
      c8: take('ballroom-queen', 'last-stand'),
      c9: take('giant-slayer'),
      c10: take('open-feast', 'hellhound'),
